...
#advancement剥奪
advancement revoke @s only yd_cb_main:using_offhand_form_0
...
execute unless items entity @s weapon.mainhand nautilus_shell[item_model="minecraft:celestial_bow"] run tag @s add yd_cb_form_0
